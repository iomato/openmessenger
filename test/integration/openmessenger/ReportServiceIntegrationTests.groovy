...
class ReportServiceIntegrationTests extends GroovyTestCase {
    protected void setUp() {            
        ...
        */
        ...
        20.times {
            def date = new SimpleDateFormat("yyyy-MMM-dd").parse("2011-DEC-${it+1}")
        ...
        new MessageLog(event:au, eventType:au.type, msisdn:'6612323434213', gateway:'dtac', msg:'add new content', 
            createBy:user1.username, date:new SimpleDateFormat("yyyy-MMM-dd").parse("2011-DEC-11"), 
            concatinationSize:1, price:2).save(failOnError:true, flush:true)
        //new Message(event:au, title:"title new", content:"add new content", createdDate:new SimpleDateFormat("yyyy-MMM-dd").parse("2011-DEC-11")).save(failOnError:true, flush:true)
    ...
    void testGetTransactionReport() {
        ...
        def fromDate = new SimpleDateFormat("yyyy-MMM-dd").parse("2011-DEC-1")
        def toDate = new SimpleDateFormat("yyyy-MMM-dd").parse("2011-DEC-20")
